...
//	public ResponseEntity<Boolean> authenticateUser(@PathVariable String userId, @PathVariable String password){
//		return  new ResponseEntity<>(this.userService.checkUserCred(userId,password),
//				HttpStatus.OK);
//	}
